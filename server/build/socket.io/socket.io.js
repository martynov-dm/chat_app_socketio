...
const ListenToSocketEndPoints = (io) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    io.of('/').on('connection', (socket) => __awaiter(void 0, void 0, void 0, function* () {
        socket.on('authenticate', (token) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                userData = yield user_model_1.default.findById(decodedData._id, '_id login avatar currentRoomId currentServerEndpoint').lean();
                const initialData = {
                    serversArr,
                    userData,
                };
    ...
    serversArr.forEach((server) => {
        io.of(server.endpoint).on('connection', (socket) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            }, { new: true }, (err, user) => (userData = user));
            ...
            socket.on('disconnect', () => __awaiter(void 0, void 0, void 0, function* () {
                const SocketsInRoomArr = Array.from((yield io
                    ...
                    .allSockets()).values());
                const usersArr = SocketsInRoomArr.map((socket) => io.of(server.endpoint).sockets.get(socket)
                    .userData);
                const filteredUsersArr = usersArr.filter((user, index, thisArray) => thisArray.findIndex((user2) => user2.login === user.login) ===
                    index);
                yield io
                    .of(server.endpoint)
                    .in(userData.currentRoomId.toString())
...
const leaveRoom = (oldRoomId, io, endpoint, socket) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const usersArr = SocketsInRoomArr.map((socket) => io.of(endpoint).sockets.get(socket).userData);
